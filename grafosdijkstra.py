...
class GrafoDirigido:
    ...
    def agregar_arista(self, origen, destino, peso=1):
        """Agrega una arista dirigida con un peso (por defecto 1) al grafo."""
    ...
    def generar_matriz_adyacencia(self):
        """Genera una matriz de adyacencia a partir de la lista de adyacencia."""
    ...
    def dijkstra(self, inicio):
        """Implementa el algoritmo de Dijkstra para encontrar el camino más corto desde el nodo 'inicio'."""
    ...
    def mostrar_camino_mas_corto(self, inicio, fin):
        """Muestra el camino más corto y su costo desde 'inicio' hasta 'fin' usando Dijkstra."""
